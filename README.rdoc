...
For now, since authr3 is really more of an example than anything else, I going to push the gem up to rubygems.org. Follow the instructions below to install authr3 as a gem and get it working with your Rails 3 app.
